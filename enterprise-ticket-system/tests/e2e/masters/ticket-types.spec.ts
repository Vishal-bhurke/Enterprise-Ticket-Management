...
test.describe('Ticket Types Master', () => {
  test.beforeEach(async ({ page }) => {
    await loginAs(page, 'admin');
    await page.goto('/masters/ticket-types');
    await page.waitForLoadState('networkidle');
  });

  test('ticket types list page loads', async ({ page }) => {
  ...
  test('create ticket type', async ({ page }) => {
    ...
    await cleanupRow('ticket_types', { name: uniqueName });
  });
